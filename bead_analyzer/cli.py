...
def main():
    ...
    parser.add_argument("input_file", type=str, help="Path to TIFF stack")
    parser.add_argument("--mode", type=str, choices=['manual', 'stardist', 'cellpose'],
                        default='manual', help="Detection mode (default: manual)")
    ...
    parser.add_argument("--review_detection", action="store_true",
                        help="Review StarDist detections before analysis")
    ...
    parser.add_argument("--blob_sigma", type=float, default=1.2,
                        help="Blob fallback Gaussian sigma (pixels)")
    parser.add_argument("--blob_threshold_rel", type=float, default=0.2,
                        help="Blob fallback threshold as fraction of dynamic range")
    parser.add_argument("--blob_min_distance", type=int, default=5,
                        help="Blob fallback minimum peak spacing (pixels)")
